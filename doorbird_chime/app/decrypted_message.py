...
class DecryptedMessage:
    def __init__(self, cleartext):
        ...
        # The type of event sent this will either be 'motion' or the product number of the device sending the alert.
        self.event = cleartext[6:14].decode('utf-8')
        # The UTC time as a timestamp.
        self.timestamp = datetime.utcfromtimestamp(int.from_bytes(cleartext[14:], 'big'))
